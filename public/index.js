...
const ITEM_CONFIG = [
	...
	{ width: 50 / 1.5, height: 50 / 1.5, id: 3, image: 'images/items/pokeball_orange.png' },
...
//게임이 시작하면 한번 실행하고 이후 리게임할 때마다 실행.
function reset() {
	...
	sendEvent(2, { timestamp: Date.now(), score: score.getScore() });
}
...
function gameLoop(currentTime) {
	...
	if (!gameover && !waitingToStart) {
		...
		itemController.update(gameSpeed, score.loadTheStage(), deltaTime);
		// 달리기
